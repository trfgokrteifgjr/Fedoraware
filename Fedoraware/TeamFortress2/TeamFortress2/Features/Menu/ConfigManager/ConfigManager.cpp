...
bool CConfigManager::SaveVisual(const std::string& configName)
{
	try
	{
		...
		SAVE_VAR(Vars::Visuals::Particles::ParticleColors);
		SAVE_VAR(Vars::Visuals::Particles::RainbowSpeed);
...
bool CConfigManager::LoadVisual(const std::string& configName)
{
	try
	{
		...
		LOAD_VAR(Vars::Visuals::Particles::ParticleColors);
		LOAD_VAR(Vars::Visuals::Particles::RainbowSpeed);
