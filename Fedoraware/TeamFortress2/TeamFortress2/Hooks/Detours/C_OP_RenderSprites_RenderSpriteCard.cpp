...
{
    float rainbowspeed = Vars::Visuals::Particles::Colors::RainbowSpeed.Value;
    return
    {
...
{
    Color_t colors = Vars::Visuals::Particles::Colors::Type.Value == 1 ? Colors::ParticleColor : Rainbow();
